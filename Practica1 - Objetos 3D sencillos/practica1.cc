...
*/
	...
	if(dibujo != -1){
			if(modo == 'p') objetos[dibujo].draw_puntos(100, 0, 0, 4);
			else if(modo == 'f') objetos[dibujo].draw_solido(100, 0, 0);
			else if(modo == 'c') objetos[dibujo].draw_solido_ajedrez(100, 0, 0, 0, 0, 100);
			else if(modo == 'm') objetos[dibujo].draw_solido_color();
			else objetos[dibujo].draw_aristas(100, 0, 0, 4);
	}
}
...
else if (toupper(Tecla1)=='P')modo='p';
else if (toupper(Tecla1)=='N')modo='n';
else if (toupper(Tecla1)=='C')modo='c';
else if (toupper(Tecla1)=='F')modo='f';
else if (toupper(Tecla1)=='M')modo='m';
glutPostRedisplay();
}
...
void mostrarMenu(){
	system("clear");
	cout << "**************************************************************************" << endl << endl;
	cout <<  "Práctica 1"																	<< endl;
	cout <<  "Jose Antonio Ruiz Millan 2017-2018"											<< endl;
	cout <<  "Objetos basicos"																<< endl<< endl;
	cout << "*************************************************************************"	<< endl << endl;
	cout <<  "Objetos:"																	<< endl;
